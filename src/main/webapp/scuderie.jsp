...
<main class="container">
	...
	<div class="row row-cols-1 row-cols-md-5 g-4" style="padding-top: 170px; padding-left: 240px">
		<f:forEach items="${scuderie}" var="scuderia">
			<div class="col">
				<div class="card " style="width: 250px; height: 350px;"><a href="scuderia?id=${scuderia.nomeScuderia}">
